...
src="leiden-communities-openmp-heuristic-dynamic"
...
: "${BATCH_UNIT:=%}"
: "${BATCH_LENGTH:=1}"
: "${BATCH_DELETIONS_BEGIN:=0.0002}"
: "${BATCH_DELETIONS_END:=0.0002}"
: "${BATCH_DELETIONS_STEP:=*=10}"
: "${BATCH_INSERTIONS_BEGIN:=0.0008}"
: "${BATCH_INSERTIONS_END:=0.0008}"
